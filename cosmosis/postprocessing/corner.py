...
def corner(xs, bins=20, range=None, weights=None, color="k",
    ...
    for i, x in enumerate(xs):
        ...
        ax.set_yticklabels([])
        ax.xaxis.set_major_locator(pl.MaxNLocator(max_n_ticks, prune="lower"))
        ...
        if i < K - 1:
            ...
            ax.xaxis.set_major_formatter(
                pl.ScalarFormatter(useMathText=use_math_text))
        ...
        for j, y in enumerate(xs):
            ...
            ax.xaxis.set_major_locator(pl.MaxNLocator(max_n_ticks, prune="lower"))
            ax.yaxis.set_major_locator(pl.MaxNLocator(max_n_ticks, prune="lower"))
...
def hist2d(x, y, bins=20, range=None, weights=None, levels=None, smooth=None,
    ...
    density_cmap = pl.matplotlib.colors.LinearSegmentedColormap.from_list(
        "density_cmap", [color, (1, 1, 1, 0)])

    # This color map is used to hide the points at the high density areas.
    white_cmap = pl.matplotlib.colors.LinearSegmentedColormap.from_list(
        "white_cmap", [(1, 1, 1), (1, 1, 1)], N=2)

    # This "color map" is the list of colors for the contour levels if the
    # contours are filled.
    rgba_color = pl.matplotlib.colors.colorConverter.to_rgba(color)
